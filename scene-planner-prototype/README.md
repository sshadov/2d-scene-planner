...
Переключатель `LIVE` в v10 является интерактивным макетом и по умолчанию выключен. Он ещё не отправляет изменения в Designer; существующий подтверждаемый экспорт оставлен без изменений до отдельной реализации LiveUpdate.
