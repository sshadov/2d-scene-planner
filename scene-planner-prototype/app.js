(() => {
  ...
  const state = {
    room: { ...defaults.room }, stage: { ...defaults.stage, enabled: true }, objects: [], selectedId: null, selectedIds: new Set(), highlightObjectId: null, zoom: 1, liveEnabled: false,
